...
class appTestDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/g')) {
            ...
            // app_clients_github
            if ($pathinfo === '/github') {
                return array (  '_controller' => 'AppBundle\\Controller\\ClientsController::github',  '_route' => 'app_clients_github',);
            }
        ...
        // app_clients_about
        if ($pathinfo === '/about') {
            return array (  '_controller' => 'AppBundle\\Controller\\ClientsController::about',  '_route' => 'app_clients_about',);
        }
